...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,893 | 🐛 93 | 🌐 JavaScript | 📅 2026-02-12 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,044 | 🐛 52 | 🌐 JavaScript | 📅 2026-02-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-12 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,430 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
...
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,852 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-04 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,917 | 🐛 402 | 🌐 JavaScript | 📅 2026-02-13 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,198 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-12 - Rules detecting bugs and suspicious patterns.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 17,998 | 🐛 368 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 539 | 🐛 22 | 🌐 JavaScript | 📅 2026-02-12 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 242,982 | 🐛 1,110 | 🌐 JavaScript | 📅 2026-02-12 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,257 | 🐛 366 | 🌐 JavaScript | 📅 2026-02-10 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,563 | 🐛 125 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,780 | 🐛 341 | 🌐 JavaScript | 📅 2026-02-12 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,601 | 🐛 214 | 🌐 JavaScript | 📅 2026-02-10 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 107 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-12 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,773 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-12 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,720 | 🐛 78 | 📅 2022-05-19.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,878 | 🐛 758 | 🌐 TypeScript | 📅 2026-02-13 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-12 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 251 | 🐛 32 | 🌐 JavaScript | 📅 2026-02-12 - ESLint plugin for HTML.
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 224 | 🐛 41 | 🌐 TypeScript | 📅 2026-02-13 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 226 | 🐛 41 | 🌐 TypeScript | 📅 2026-02-02 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 118 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-12 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 680 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-12 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-12 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,872 | 🐛 594 | 🌐 JavaScript | 📅 2025-12-30 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 785 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-03 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 648 | 🐛 70 | 🌐 TypeScript | 📅 2025-10-29 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 12 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-12 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,322 | 🐛 15 | 🌐 JavaScript | 📅 2026-02-13 - ESLint rules for Node Security.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,813 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-12 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,167 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-12 - Linting rules for Jest.
  * [Jest-DOM](https://github.com/testing-library/eslint-plugin-jest-dom) ⭐ 366 | 🐛 14 | 🌐 JavaScript | 📅 2026-02-08 - Linting rules for Jest-DOM.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,043 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-12 - Linting rules for Testing Library.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,878 | 🐛 758 | 🌐 TypeScript | 📅 2026-02-13 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,942 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [codacy-eslint](https://github.com/codacy/codacy-eslint) ⭐ 16 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-12 - Docker used at [Codacy](https://www.codacy.com) to run ESLint.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 106 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-12 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
