...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,244 | 🐛 108 | 🌐 JavaScript | 📅 2026-05-12 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,175 | 🐛 52 | 🌐 JavaScript | 📅 2026-05-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,655 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-08 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,440 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 284 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-04 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,971 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-02.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,012 | 🐛 375 | 🌐 JavaScript | 📅 2026-05-11 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,233 | 🐛 25 | 🌐 TypeScript | 📅 2026-05-11 - Rules detecting bugs and suspicious patterns.
...
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 330 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-11 - Misc. rules from GitHub.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,012 | 🐛 375 | 🌐 JavaScript | 📅 2026-05-06 - ESLint rules for emotion.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,964 | 🐛 1,288 | 🌐 JavaScript | 📅 2026-05-12 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,281 | 🐛 354 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,782 | 🐛 369 | 🌐 JavaScript | 📅 2026-05-12 - Meteor specific linting rules for ESLint.
* Vue
...
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 426 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-07 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,900 | 🐛 753 | 🌐 TypeScript | 📅 2026-05-12 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 261 | 🐛 31 | 🌐 JavaScript | 📅 2026-05-11 - ESLint plugin for HTML.
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 237 | 🐛 26 | 🌐 TypeScript | 📅 2026-05-11 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 233 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-11 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 120 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-09 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,062 | 🐛 138 | 🌐 JavaScript | 📅 2026-04-24 - Linting rules for Tailwind CSS classnames.
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-05-06 - Check your GraphQL query strings against a schema.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 773 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-28 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [jQuery](https://github.com/wikimedia/eslint-plugin-no-jquery) ⭐ 33 | 🐛 18 | 🌐 JavaScript | 📅 2026-05-06 - Linting rules for jQuery, including versioned configs for deprecated features.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-11 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-11 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,909 | 🐛 593 | 🌐 JavaScript | 📅 2026-04-27 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 974 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-07 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 883 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-11 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-11 - ESLint plugin related to Math object and Number.
...
* [eslint-plugin-hex-under](https://github.com/2nd-Labs/eslint-plugin-hex-under) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-08 - A plugin to prove that a hexadecimal number is less than a specified value.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 11 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-11 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,166 | 🐛 28 | 🌐 TypeScript | 📅 2026-05-11 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 37 | 🌐 TypeScript | 📅 2026-05-11 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 726 | 🐛 27 | 🌐 JavaScript | 📅 2026-05-11 - Linting rules for Cypress.
* Vitest
...
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 382 | 🐛 3 | 🌐 TypeScript | 📅 2026-05-07 - Linting rules for Playwright.
* Mocha
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,900 | 🐛 753 | 🌐 TypeScript | 📅 2026-05-12 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,391 | 🐛 2,383 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-11 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [eslint-multiplexer](https://github.com/pimlie/eslint-multiplexer) ⭐ 7 | 🐛 14 | 🌐 JavaScript | 📅 2026-05-09 - Multiplex eslint results and merge results for common files.
