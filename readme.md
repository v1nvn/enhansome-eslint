...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,107 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,107 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,880 | 🐛 92 | 🌐 JavaScript | 📅 2026-02-09 - Contains the ESLint configuration used for projects maintained by the ESLint team.
* [Alloy](https://github.com/AlloyTeam/eslint-config-alloy) ⭐ 2,645 | 🐛 10 | 🌐 JavaScript | 📅 2024-01-11 - Progressive ESLint config for your React/Vue/TypeScript projects.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,042 | 🐛 50 | 🌐 JavaScript | 📅 2026-02-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-07 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,431 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
...
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,851 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-04 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,914 | 🐛 406 | 🌐 JavaScript | 📅 2026-02-10 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,199 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-10 - Rules detecting bugs and suspicious patterns.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 17,997 | 🐛 368 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,301 | 🐛 88 | 🌐 TypeScript | 📅 2025-12-28 styles.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 242,928 | 🐛 1,113 | 🌐 JavaScript | 📅 2026-02-10 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,256 | 🐛 366 | 🌐 JavaScript | 📅 2026-02-10 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,776 | 🐛 332 | 🌐 JavaScript | 📅 2026-02-10 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,600 | 🐛 212 | 🌐 JavaScript | 📅 2026-02-10 - Plugin for VueJS.
...
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,721 | 🐛 78 | 📅 2022-05-19.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 400 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-07 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 389 | 🐛 128 | 🌐 TypeScript | 📅 2026-02-10 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 173 | 🌐 JavaScript | 📅 2026-02-02 - Linting rules for Ember.
* [Solid](https://github.com/joshwilsonvu/eslint-plugin-solid) ⭐ 256 | 🐛 41 | 🌐 TypeScript | 📅 2026-01-29 - Linting rules for Solid and JSX.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,879 | 🐛 755 | 🌐 TypeScript | 📅 2026-02-10 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-10 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 251 | 🐛 31 | 🌐 JavaScript | 📅 2026-02-10 - ESLint plugin for HTML.
* JSON
  * [JSON with Comments](https://github.com/ota-meshi/eslint-plugin-jsonc) ⭐ 231 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin for JSON, JSONC and JSON5.
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 223 | 🐛 38 | 🌐 TypeScript | 📅 2026-02-10 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 118 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-10 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,196 | 🐛 33 | 🌐 JavaScript | 📅 2026-02-07 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 678 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
  ...
  * [Lodash template](https://github.com/ota-meshi/eslint-plugin-lodash-template) ⭐ 17 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-10 - Plugin for Lodash template/Underscore template.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-10 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-10 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,871 | 🐛 594 | 🌐 JavaScript | 📅 2025-12-30 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 645 | 🐛 68 | 🌐 TypeScript | 📅 2025-10-29 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [@eslint-community/eslint-plugin-eslint-comments](https://github.com/eslint-community/eslint-plugin-eslint-comments) ⭐ 91 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-08 - Best practices about ESLint directive comments (`/*eslint-disable*/`, etc.). Properly maintained fork of no longer maintained `eslint-plugin-eslint-comments`.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 755 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 12 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,811 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-08 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,407 | 🐛 8 | 🌐 JavaScript | 📅 2026-01-22 - Easy autofixable import sorting.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,043 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-11 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 25 | 🌐 JavaScript | 📅 2026-02-09 - Linting rules for Cypress.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,879 | 🐛 755 | 🌐 TypeScript | 📅 2026-02-10 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,943 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-disable-autofix](https://github.com/MorevM/eslint-disable-autofix/) ⭐ 2 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-10 - Utility to disable autofix for specific ESLint rules.
