...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,111 | 🐛 188 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,111 | 🐛 188 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,247 | 🐛 104 | 🌐 JavaScript | 📅 2026-03-12 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,096 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-12 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,653 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-05 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,431 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,952 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-03.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,952 | 🐛 50 | 🌐 TypeScript | 📅 2026-03-03 - JavaScript happiness style linter ❤️.
...
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,204 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-12 - Rules detecting bugs and suspicious patterns.
...
* [De Morgan](https://github.com/azat-io/eslint-plugin-de-morgan) ⭐ 307 | 🐛 0 | 🌐 TypeScript | 📅 2026-03-11 - Transforms logical expressions in code to make them easier to understand.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,916 | 🐛 1,164 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for React Hooks.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,776 | 🐛 369 | 🌐 JavaScript | 📅 2026-03-11 - Meteor specific linting rules for ESLint.
* Vue
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,778 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-11 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,709 | 🐛 77 | 📅 2022-05-19.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 393 | 🐛 136 | 🌐 TypeScript | 📅 2026-03-10 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 225 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for Ember.
* [Solid](https://github.com/joshwilsonvu/eslint-plugin-solid) ⭐ 259 | 🐛 42 | 🌐 TypeScript | 📅 2026-02-26 - Linting rules for Solid and JSX.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,902 | 🐛 748 | 🌐 TypeScript | 📅 2026-03-11 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 256 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-11 - ESLint plugin for HTML.
* JSON
  * [JSON with Comments](https://github.com/ota-meshi/eslint-plugin-jsonc) ⭐ 233 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin for JSON, JSONC and JSON5.
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 225 | 🐛 21 | 🌐 TypeScript | 📅 2026-03-12 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 229 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-11 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 118 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-11 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-10 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,050 | 🐛 136 | 🌐 JavaScript | 📅 2025-09-15 - Linting rules for Tailwind CSS classnames.
* GraphQL
  ...
  * [dotansimha/graphql-eslint](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-11 - Validates, prettifies and checks your GraphQL operations and GraphQL schema for best-practices.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 718 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-11 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-11 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,881 | 🐛 596 | 🌐 JavaScript | 📅 2026-03-05 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 800 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-11 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 12 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-10 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,835 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-11 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,047 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-11 - Linting rules for Testing Library.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,902 | 🐛 748 | 🌐 TypeScript | 📅 2026-03-11 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
* [GraphQL](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-11 - Parser for the GraphQL AST. Includes parser, plugin, processor (for non-graphql files) and rules.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,821 | 🐛 2,370 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
