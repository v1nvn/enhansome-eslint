...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,101 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,101 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,906 | 🐛 93 | 🌐 JavaScript | 📅 2026-02-18 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,048 | 🐛 54 | 🌐 JavaScript | 📅 2026-02-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-17 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,428 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,928 | 🐛 385 | 🌐 JavaScript | 📅 2026-02-15 - Various awesome ESLint rules.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,000 | 🐛 368 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,055 | 🐛 1,122 | 🌐 JavaScript | 📅 2026-02-18 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,261 | 🐛 362 | 🌐 JavaScript | 📅 2026-02-17 - Linting rules for React and JSX.
  ...
  * [React Refresh](https://github.com/ArnaudBarre/eslint-plugin-react-refresh) ⭐ 324 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-01 - Improve HMR experience when using Vite.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,784 | 🐛 344 | 🌐 JavaScript | 📅 2026-02-17 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,600 | 🐛 204 | 🌐 JavaScript | 📅 2026-02-16 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,774 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-17 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,718 | 🐛 78 | 📅 2022-05-19.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 390 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-17 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 190 | 🌐 JavaScript | 📅 2026-02-18 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,875 | 🐛 754 | 🌐 TypeScript | 📅 2026-02-17 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [N](https://github.com/eslint-community/eslint-plugin-n) ⭐ 325 | 🐛 50 | 🌐 JavaScript | 📅 2026-02-15 - Additional ESLint's rules for Node.js. Properly maintained fork of no longer maintained `eslint-plugin-node`.
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 254 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-17 - ESLint plugin for HTML.
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 224 | 🐛 38 | 🌐 TypeScript | 📅 2026-02-17 - Rules for consistent, readable, and valid package.json files.
...
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 173 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-17 - ESLint plugin for YAML.
...
* [TOML](https://github.com/ota-meshi/eslint-plugin-toml) ⭐ 32 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-17 - ESLint plugin for TOML.

### Libraries

* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,047 | 🐛 133 | 🌐 JavaScript | 📅 2025-09-15 - Linting rules for Tailwind CSS classnames.
* GraphQL
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,197 | 🐛 35 | 🌐 JavaScript | 📅 2026-02-18 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-17 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-17 linter into ESLint.
* [Diff](https://github.com/paleite/eslint-plugin-diff) ⭐ 209 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-16 - Run ESLint on your changed lines only. Also supports CI!
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,869 | 🐛 594 | 🌐 JavaScript | 📅 2025-12-30 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [fp](https://github.com/jfmengels/eslint-plugin-fp) ⭐ 972 | 🐛 31 | 🌐 JavaScript | 📅 2021-01-01 - ESLint rules for functional programming.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 961 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-18 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 652 | 🐛 74 | 🌐 TypeScript | 📅 2026-02-17 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [eslint-plugin-exception-handling](https://github.com/Akronae/eslint-plugin-exception-handling) ⭐ 59 | 🐛 3 | 🌐 TypeScript | 📅 2025-10-25 - Lints unhandled functions that might throw errors.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,813 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-17 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,044 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-17 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 369 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Playwright.
* Mocha
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,875 | 🐛 754 | 🌐 TypeScript | 📅 2026-02-17 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,935 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
