...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,129 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,129 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,203 | 🐛 100 | 🌐 JavaScript | 📅 2026-03-19 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,109 | 🐛 48 | 🌐 JavaScript | 📅 2026-03-17 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,653 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-15 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,435 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,962 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-14.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,962 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-14 - JavaScript happiness style linter ❤️.
...
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,207 | 🐛 28 | 🌐 TypeScript | 📅 2026-03-19 - Rules detecting bugs and suspicious patterns.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,008 | 🐛 371 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,087 | 🐛 1,192 | 🌐 JavaScript | 📅 2026-03-20 - Linting rules for React Hooks.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,776 | 🐛 374 | 🌐 JavaScript | 📅 2026-03-19 - Meteor specific linting rules for ESLint.
* Vue
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,779 | 🐛 32 | 🌐 TypeScript | 📅 2026-03-19 - Linting rules for Angular (v2+).
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 394 | 🐛 133 | 🌐 TypeScript | 📅 2026-03-19 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 193 | 🌐 JavaScript | 📅 2026-03-20 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,906 | 🐛 756 | 🌐 TypeScript | 📅 2026-03-20 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 24 | 🌐 TypeScript | 📅 2026-03-19 - ESLint Parser/Plugin for MDX.
...
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 227 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-19 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-19 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 805 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-17 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 757 | 🐛 18 | 🌐 TypeScript | 📅 2026-03-19 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,840 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-17 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,049 | 🐛 36 | 🌐 TypeScript | 📅 2026-03-19 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 724 | 🐛 26 | 🌐 JavaScript | 📅 2026-03-18 - Linting rules for Cypress.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,906 | 🐛 756 | 🌐 TypeScript | 📅 2026-03-20 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,825 | 🐛 2,374 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
