...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,116 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,116 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,244 | 🐛 108 | 🌐 JavaScript | 📅 2026-03-12 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,098 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-12 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,653 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-12 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,433 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,951 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-12.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,951 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-12 - JavaScript happiness style linter ❤️.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,948 | 🐛 376 | 🌐 JavaScript | 📅 2026-03-05 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,204 | 🐛 18 | 🌐 TypeScript | 📅 2026-03-12 - Rules detecting bugs and suspicious patterns.
* [depend](https://github.com/es-tooling/eslint-plugin-depend) ⭐ 477 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-09 - Helps detect dependency tree bloat and redundant polyfills.
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 327 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-10 - Misc. rules from GitHub.
...
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 150 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-08 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,319 | 🐛 88 | 🌐 TypeScript | 📅 2026-02-22 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 543 | 🐛 21 | 🌐 JavaScript | 📅 2026-03-11 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,942 | 🐛 1,165 | 🌐 JavaScript | 📅 2026-03-12 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,270 | 🐛 339 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,777 | 🐛 369 | 🌐 JavaScript | 📅 2026-03-12 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 205 | 🌐 TypeScript | 📅 2026-03-11 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,778 | 🐛 36 | 🌐 TypeScript | 📅 2026-03-13 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,708 | 🐛 77 | 📅 2022-05-19.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 408 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-11 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 393 | 🐛 136 | 🌐 TypeScript | 📅 2026-03-12 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 193 | 🌐 JavaScript | 📅 2026-03-13 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,904 | 🐛 751 | 🌐 TypeScript | 📅 2026-03-13 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-12 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 256 | 🐛 28 | 🌐 JavaScript | 📅 2026-03-12 - ESLint plugin for HTML.
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 225 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-12 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-12 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* GraphQL
  ...
  * [dotansimha/graphql-eslint](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-12 - Validates, prettifies and checks your GraphQL operations and GraphQL schema for best-practices.
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,205 | 🐛 32 | 🌐 JavaScript | 📅 2026-03-12 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 719 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-12 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-12 linter into ESLint.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 801 | 🐛 31 | 🌐 TypeScript | 📅 2026-03-12 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 675 | 🐛 69 | 🌐 TypeScript | 📅 2026-03-11 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [new-with-error](https://github.com/Trott/eslint-plugin-new-with-error) ⭐ 26 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-11 - Require errors to be thrown using `new`.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,331 | 🐛 14 | 🌐 JavaScript | 📅 2026-03-05 - ESLint rules for Node Security.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,835 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-11 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,047 | 🐛 35 | 🌐 TypeScript | 📅 2026-03-12 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 23 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for Cypress.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,904 | 🐛 751 | 🌐 TypeScript | 📅 2026-03-13 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
* [GraphQL](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 80 | 🌐 TypeScript | 📅 2026-03-12 - Parser for the GraphQL AST. Includes parser, plugin, processor (for non-graphql files) and rules.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,828 | 🐛 2,374 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 245 | 🐛 2 | 🌐 JavaScript | 📅 2026-03-10 - Generate ESLint
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-11 - CLI tool for testing given ESlint rules against multiple repositories at once.
