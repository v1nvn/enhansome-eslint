...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,103 | 🐛 187 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,103 | 🐛 187 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,181 | 🐛 106 | 🌐 JavaScript | 📅 2026-03-08 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,652 | 🐛 29 | 🌐 TypeScript | 📅 2026-03-05 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,433 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,006 | 🐛 370 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,314 | 🐛 89 | 🌐 TypeScript | 📅 2026-02-22 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 543 | 🐛 23 | 🌐 JavaScript | 📅 2026-03-08 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,736 | 🐛 1,152 | 🌐 JavaScript | 📅 2026-03-05 - Linting rules for React Hooks.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,779 | 🐛 376 | 🌐 JavaScript | 📅 2026-03-06 - Meteor specific linting rules for ESLint.
* Vue
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,778 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-08 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,710 | 🐛 77 | 📅 2022-05-19.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 392 | 🐛 140 | 🌐 TypeScript | 📅 2026-03-05 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 200 | 🌐 JavaScript | 📅 2026-03-09 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,897 | 🐛 749 | 🌐 TypeScript | 📅 2026-03-07 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 224 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-09 - Rules for consistent, readable, and valid package.json files.
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,048 | 🐛 136 | 🌐 JavaScript | 📅 2025-09-15 - Linting rules for Tailwind CSS classnames.
* GraphQL
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-08 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-08 linter into ESLint.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 799 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-08 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 667 | 🐛 72 | 🌐 TypeScript | 📅 2026-03-03 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-08 - ESLint plugin related to Math object and Number.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 757 | 🐛 19 | 🌐 TypeScript | 📅 2026-03-09 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [no-unsanitized](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 242 | 🐛 33 | 🌐 JavaScript | 📅 2026-03-03 - Checks for `innerHTML`, `outerHTML`, etc.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,832 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-08 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,411 | 🐛 8 | 🌐 JavaScript | 📅 2026-02-28 - Easy autofixable import sorting.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,165 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-09 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,047 | 🐛 36 | 🌐 TypeScript | 📅 2026-03-09 - Linting rules for Testing Library.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,897 | 🐛 749 | 🌐 TypeScript | 📅 2026-03-07 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-09 - CLI tool for testing given ESlint rules against multiple repositories at once.
