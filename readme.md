...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,109 | 🐛 188 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,109 | 🐛 188 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,247 | 🐛 106 | 🌐 JavaScript | 📅 2026-03-10 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,090 | 🐛 48 | 🌐 JavaScript | 📅 2026-03-10 - Anthony's ESLint config preset.
...
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,866 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-01 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,944 | 🐛 376 | 🌐 JavaScript | 📅 2026-03-05 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,204 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-10 - Rules detecting bugs and suspicious patterns.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,004 | 🐛 371 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 543 | 🐛 22 | 🌐 JavaScript | 📅 2026-03-11 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,879 | 🐛 1,165 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,270 | 🐛 344 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,777 | 🐛 369 | 🌐 JavaScript | 📅 2026-03-10 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 205 | 🌐 TypeScript | 📅 2026-03-10 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,778 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-11 - Linting rules for Angular (v2+).
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 392 | 🐛 136 | 🌐 TypeScript | 📅 2026-03-10 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 205 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,901 | 🐛 748 | 🌐 TypeScript | 📅 2026-03-10 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 256 | 🐛 27 | 🌐 JavaScript | 📅 2026-03-10 - ESLint plugin for HTML.
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 225 | 🐛 23 | 🌐 TypeScript | 📅 2026-03-10 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 229 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-10 - An ESLint plugin for linting ESLint plugins.
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,205 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-28 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 717 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-10 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-10 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,881 | 🐛 595 | 🌐 JavaScript | 📅 2026-03-05 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 800 | 🐛 30 | 🌐 TypeScript | 📅 2026-03-10 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 671 | 🐛 72 | 🌐 TypeScript | 📅 2026-03-03 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-11 - ESLint plugin related to Math object and Number.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,835 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-10 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,046 | 🐛 36 | 🌐 TypeScript | 📅 2026-03-10 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 722 | 🐛 23 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for Cypress.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,901 | 🐛 748 | 🌐 TypeScript | 📅 2026-03-10 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,823 | 🐛 2,370 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
