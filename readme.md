...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,238 | 🐛 109 | 🌐 JavaScript | 📅 2026-05-09 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Shopify](https://github.com/Shopify/web-foundation/blob/main/packages/eslint-plugin/README.md) ⭐ 489 | 🐛 20 | 🌐 JavaScript | 📅 2026-05-08 - Shareable config for [Shopify's style guide](https://github.com/Shopify/javascript) ⭐ 262 | 🐛 13 | 📅 2022-07-14.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,172 | 🐛 56 | 🌐 JavaScript | 📅 2026-04-30 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,655 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-08 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,439 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 284 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-04 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,971 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,971 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02 - JavaScript happiness style linter ❤️.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,010 | 🐛 375 | 🌐 JavaScript | 📅 2026-05-06 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,233 | 🐛 23 | 🌐 TypeScript | 📅 2026-05-09 - Rules detecting bugs and suspicious patterns.
...
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 329 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-08 - Misc. rules from GitHub.
...
* Styled Components
  * [styled-components-a11y](https://github.com/brendanmorrell/eslint-plugin-styled-components-a11y) ⭐ 155 | 🐛 8 | 🌐 JavaScript | 📅 2026-01-22 - A11y for Styled Components.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 565 | 🐛 13 | 🌐 JavaScript | 📅 2026-05-07 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,904 | 🐛 1,289 | 🌐 JavaScript | 📅 2026-05-09 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,282 | 🐛 351 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,771 | 🐛 367 | 🌐 JavaScript | 📅 2026-05-07 - Meteor specific linting rules for ESLint.
* Vue
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,898 | 🐛 755 | 🌐 TypeScript | 📅 2026-05-09 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 237 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-10 - Rules for consistent, readable, and valid package.json files.
...
* [jQuery](https://github.com/wikimedia/eslint-plugin-no-jquery) ⭐ 32 | 🐛 18 | 🌐 JavaScript | 📅 2026-05-06 - Linting rules for jQuery, including versioned configs for deprecated features.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-08 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-08 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,908 | 🐛 593 | 🌐 JavaScript | 📅 2026-04-27 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 97 | 🐛 10 | 🌐 JavaScript | 📅 2026-05-04 - Avoid redundancy when using es2015 array methods and functions.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,863 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-05 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,166 | 🐛 28 | 🌐 TypeScript | 📅 2026-05-09 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-09 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 726 | 🐛 24 | 🌐 JavaScript | 📅 2026-05-06 - Linting rules for Cypress.
* Vitest
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,898 | 🐛 755 | 🌐 TypeScript | 📅 2026-05-09 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,388 | 🐛 2,381 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 245 | 🐛 2 | 🌐 JavaScript | 📅 2026-05-07 - Generate ESLint
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-09 - CLI tool for testing given ESlint rules against multiple repositories at once.
