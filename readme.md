...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,126 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,126 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,212 | 🐛 101 | 🌐 JavaScript | 📅 2026-03-16 - Contains the ESLint configuration used for projects maintained by the ESLint team.
* [Alloy](https://github.com/AlloyTeam/eslint-config-alloy) ⭐ 2,643 | 🐛 10 | 🌐 JavaScript | 📅 2024-01-11 - Progressive ESLint config for your React/Vue/TypeScript projects.
* [Shopify](https://github.com/Shopify/web-foundation/blob/main/packages/eslint-plugin/README.md) ⭐ 491 | 🐛 21 | 🌐 JavaScript | 📅 2026-01-27 - Shareable config for [Shopify's style guide](https://github.com/Shopify/javascript) ⭐ 263 | 🐛 13 | 📅 2022-07-14.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,110 | 🐛 47 | 🌐 JavaScript | 📅 2026-03-17 - Anthony's ESLint config preset.
...
* [Hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) ⭐ 463 | 🐛 46 | 🌐 JavaScript | 📅 2026-03-14 - The most strict (but practical) ESLint config out there.
...
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,867 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-01 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,955 | 🐛 376 | 🌐 JavaScript | 📅 2026-03-05 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,207 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-16 - Rules detecting bugs and suspicious patterns.
...
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 150 | 🐛 7 | 🌐 JavaScript | 📅 2026-03-16 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,320 | 🐛 87 | 🌐 TypeScript | 📅 2026-03-17 styles.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,991 | 🐛 1,173 | 🌐 JavaScript | 📅 2026-03-16 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,274 | 🐛 340 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,568 | 🐛 127 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,779 | 🐛 373 | 🌐 JavaScript | 📅 2026-03-16 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 204 | 🌐 TypeScript | 📅 2026-03-16 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,778 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-17 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,704 | 🐛 77 | 📅 2022-05-19.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 394 | 🐛 137 | 🌐 TypeScript | 📅 2026-03-16 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 148 | 🌐 JavaScript | 📅 2026-03-16 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,905 | 🐛 752 | 🌐 TypeScript | 📅 2026-03-16 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-16 - ESLint Parser/Plugin for MDX.
...
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 227 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-16 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 229 | 🐛 37 | 🌐 TypeScript | 📅 2026-03-16 - An ESLint plugin for linting ESLint plugins.
...
* GraphQL
  ...
  * [dotansimha/graphql-eslint](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-13 - Validates, prettifies and checks your GraphQL operations and GraphQL schema for best-practices.
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,205 | 🐛 32 | 🌐 JavaScript | 📅 2026-03-14 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 726 | 🐛 21 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-16 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-16 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,885 | 🐛 596 | 🌐 JavaScript | 📅 2026-03-05 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 802 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-16 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 676 | 🐛 74 | 🌐 TypeScript | 📅 2026-03-16 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 96 | 🐛 10 | 🌐 JavaScript | 📅 2026-03-11 - Avoid redundancy when using es2015 array methods and functions.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 4 | 🌐 TypeScript | 📅 2026-03-11 - ESLint plugin related to Math object and Number.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 756 | 🐛 18 | 🌐 TypeScript | 📅 2026-03-14 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 12 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-16 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,335 | 🐛 14 | 🌐 JavaScript | 📅 2026-03-05 - ESLint rules for Node Security.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,838 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-11 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,048 | 🐛 34 | 🌐 TypeScript | 📅 2026-03-17 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 26 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 377 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-14 - Linting rules for Playwright.
* Mocha
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,905 | 🐛 752 | 🌐 TypeScript | 📅 2026-03-16 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
* [GraphQL](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 79 | 🌐 TypeScript | 📅 2026-03-13 - Parser for the GraphQL AST. Includes parser, plugin, processor (for non-graphql files) and rules.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,828 | 🐛 2,373 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
* [ES and browser globals](https://github.com/sindresorhus/globals) ⭐ 567 | 🐛 10 | 🌐 JavaScript | 📅 2026-03-01 (originally from ESLint)
