...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,241 | 🐛 109 | 🌐 JavaScript | 📅 2026-05-11 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,174 | 🐛 52 | 🌐 JavaScript | 📅 2026-05-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,655 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-08 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,438 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,011 | 🐛 375 | 🌐 JavaScript | 📅 2026-05-06 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,233 | 🐛 26 | 🌐 TypeScript | 📅 2026-05-10 - Rules detecting bugs and suspicious patterns.
...
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 329 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-11 - Misc. rules from GitHub.
...
* [Deslint](https://github.com/jaydrao215/deslint) ⭐ 2 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-04 - The design quality gate for AI-generated frontend code. 20 rules covering arbitrary colors/spacing/typography, design-system drift, responsive coverage, and WCAG 2.2 / 2.1 AA accessibility across React, Vue, Svelte, Angular, and plain HTML.

### Compatibility

* [Compat](https://github.com/amilajack/eslint-plugin-compat) ⭐ 3,168 | 🐛 86 | 🌐 TypeScript | 📅 2026-04-29 - Lint browser compatibility of APIs used ([caniuse](http://caniuse.com/#search=fetch) as an ESLint plugin).
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,010 | 🐛 375 | 🌐 JavaScript | 📅 2026-05-06 - ESLint rules for emotion.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,939 | 🐛 1,292 | 🌐 JavaScript | 📅 2026-05-09 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,284 | 🐛 353 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,772 | 🐛 367 | 🌐 JavaScript | 📅 2026-05-07 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,596 | 🐛 207 | 🌐 TypeScript | 📅 2026-05-05 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,782 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-09 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,664 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 403 | 🐛 129 | 🌐 TypeScript | 📅 2026-05-08 - Linting rules for Svelte v3 Components.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,902 | 🐛 754 | 🌐 TypeScript | 📅 2026-05-10 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 300 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-08 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 261 | 🐛 31 | 🌐 JavaScript | 📅 2026-05-09 - ESLint plugin for HTML.
* JSON
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 233 | 🐛 35 | 🌐 TypeScript | 📅 2026-05-04 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-10 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 772 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-28 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-10 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-10 linter into ESLint.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 882 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-06 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 97 | 🐛 14 | 🌐 JavaScript | 📅 2026-05-11 - Avoid redundancy when using es2015 array methods and functions.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-09 - ESLint plugin related to Math object and Number.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 759 | 🐛 26 | 🌐 TypeScript | 📅 2026-05-08 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 11 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-08 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,863 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-10 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,444 | 🐛 6 | 🌐 JavaScript | 📅 2026-04-06 - Easy autofixable import sorting.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-11 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 726 | 🐛 25 | 🌐 JavaScript | 📅 2026-05-11 - Linting rules for Cypress.
* Vitest
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,902 | 🐛 754 | 🌐 TypeScript | 📅 2026-05-10 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,392 | 🐛 2,382 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 6 | 🌐 TypeScript | 📅 2026-05-11 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [codacy-eslint](https://github.com/codacy/codacy-eslint) ⭐ 16 | 🐛 48 | 🌐 TypeScript | 📅 2026-05-08 - Docker used at [Codacy](https://www.codacy.com) to run ESLint.
