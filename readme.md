...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,219 | 🐛 111 | 🌐 JavaScript | 📅 2026-04-28 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Canonical](https://github.com/gajus/eslint-config-canonical) ⭐ 625 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-05 - Shareable config for [Canonical style guide](https://github.com/gajus/canonical) ⭐ 19 | 🐛 6 | 🌐 JavaScript | 📅 2017-01-11.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,166 | 🐛 52 | 🌐 JavaScript | 📅 2026-04-30 - Anthony's ESLint config preset.
...
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 285 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-04 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,970 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02.
...
* [Cecilia](https://github.com/SandroMiguel/eslint-config-cecilia) ⭐ 7 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-30 - ESLint configuration for awesome projects.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,970 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02 - JavaScript happiness style linter ❤️.
...
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,230 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-01 - Rules detecting bugs and suspicious patterns.
...
* [Deslint](https://github.com/jaydrao215/deslint) ⭐ 2 | 🐛 8 | 🌐 TypeScript | 📅 2026-04-30 - The design quality gate for AI-generated frontend code. 20 rules covering arbitrary colors/spacing/typography, design-system drift, responsive coverage, and WCAG 2.2 / 2.1 AA accessibility across React, Vue, Svelte, Angular, and plain HTML.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-29 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,367 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-22 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 566 | 🐛 13 | 🌐 JavaScript | 📅 2026-04-30 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,772 | 🐛 1,257 | 🌐 JavaScript | 📅 2026-04-29 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,279 | 🐛 349 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,769 | 🐛 357 | 🌐 JavaScript | 📅 2026-05-01 - Meteor specific linting rules for ESLint.
* Vue
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,782 | 🐛 44 | 🌐 TypeScript | 📅 2026-04-30 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,670 | 🐛 0 | 🌐 Vim Snippet | 📅 2026-04-30.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 424 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-30 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
...
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 262 | 🐛 158 | 🌐 JavaScript | 📅 2026-04-30 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,895 | 🐛 755 | 🌐 TypeScript | 📅 2026-05-01 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [N](https://github.com/eslint-community/eslint-plugin-n) ⭐ 331 | 🐛 41 | 🌐 JavaScript | 📅 2026-04-30 - Additional ESLint's rules for Node.js. Properly maintained fork of no longer maintained `eslint-plugin-node`.
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 299 | 🐛 24 | 🌐 TypeScript | 📅 2026-04-30 - ESLint Parser/Plugin for MDX.
...
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 234 | 🐛 33 | 🌐 TypeScript | 📅 2026-04-30 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 232 | 🐛 35 | 🌐 TypeScript | 📅 2026-04-30 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-30 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-05-01 - Check your GraphQL query strings against a schema.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 765 | 🐛 19 | 🌐 TypeScript | 📅 2026-04-28 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-30 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-30 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,906 | 🐛 592 | 🌐 JavaScript | 📅 2026-04-27 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 975 | 🐛 17 | 🌐 TypeScript | 📅 2026-05-01 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,346 | 🐛 18 | 🌐 JavaScript | 📅 2026-03-28 - ESLint rules for Node Security.
* [no-unsanitized](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 244 | 🐛 32 | 🌐 JavaScript | 📅 2026-04-08 - Checks for `innerHTML`, `outerHTML`, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 39 | 🌐 TypeScript | 📅 2026-05-01 - Linting rules for Testing Library.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,895 | 🐛 755 | 🌐 TypeScript | 📅 2026-05-01 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,464 | 🐛 2,378 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
* [ES and browser globals](https://github.com/sindresorhus/globals) ⭐ 580 | 🐛 11 | 🌐 JavaScript | 📅 2026-05-01 (originally from ESLint)
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 245 | 🐛 2 | 🌐 JavaScript | 📅 2026-04-30 - Generate ESLint
...
* [codacy-eslint](https://github.com/codacy/codacy-eslint) ⭐ 16 | 🐛 47 | 🌐 TypeScript | 📅 2026-04-30 - Docker used at [Codacy](https://www.codacy.com) to run ESLint.
