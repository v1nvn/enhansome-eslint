...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,234 | 🐛 108 | 🌐 JavaScript | 📅 2026-05-08 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) ⭐ 468 | 🐛 49 | 🌐 JavaScript | 📅 2026-05-09 - The most strict (but practical) ESLint config out there.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,010 | 🐛 376 | 🌐 JavaScript | 📅 2026-05-06 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,232 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-08 - Rules detecting bugs and suspicious patterns.
...
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 328 | 🐛 16 | 🌐 JavaScript | 📅 2026-05-08 - Misc. rules from GitHub.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,011 | 🐛 375 | 🌐 JavaScript | 📅 2026-05-06 - ESLint rules for emotion.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,882 | 🐛 1,285 | 🌐 JavaScript | 📅 2026-05-08 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,281 | 🐛 351 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,580 | 🐛 133 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
...
* Vue
  ...
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 108 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-08 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,782 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-07 - Linting rules for Angular (v2+).
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,898 | 🐛 756 | 🌐 TypeScript | 📅 2026-05-08 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 261 | 🐛 30 | 🌐 JavaScript | 📅 2026-05-08 - ESLint plugin for HTML.
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 237 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-09 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 120 | 🐛 21 | 🌐 TypeScript | 📅 2026-05-07 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-09 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 881 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-06 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,864 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-05 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,166 | 🐛 28 | 🌐 TypeScript | 📅 2026-05-08 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 42 | 🌐 TypeScript | 📅 2026-05-09 - Linting rules for Testing Library.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,898 | 🐛 756 | 🌐 TypeScript | 📅 2026-05-08 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,389 | 🐛 2,380 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 109 | 🐛 52 | 🌐 TypeScript | 📅 2026-05-08 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
