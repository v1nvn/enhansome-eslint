...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,122 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,122 | 🐛 189 | 🌐 JavaScript | 📅 2026-02-24.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,210 | 🐛 98 | 🌐 JavaScript | 📅 2026-03-20 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,964 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-14.

### Other Configs

* [Hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) ⭐ 462 | 🐛 46 | 🌐 JavaScript | 📅 2026-03-14 - The most strict (but practical) ESLint config out there.
* [Sheriff](https://github.com/AndreaPontrandolfo/sheriff) ⭐ 180 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-16 - Comprehensive and highly opinionated Eslint configuration. Typescript oriented.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,964 | 🐛 38 | 🌐 TypeScript | 📅 2026-03-14 - JavaScript happiness style linter ❤️.
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,872 | 🐛 19 | 🌐 JavaScript | 📅 2026-03-01 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,954 | 🐛 376 | 🌐 JavaScript | 📅 2026-03-19 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,207 | 🐛 27 | 🌐 TypeScript | 📅 2026-03-21 - Rules detecting bugs and suspicious patterns.
...
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 328 | 🐛 18 | 🌐 JavaScript | 📅 2026-03-16 - Misc. rules from GitHub.
...
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 149 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-19 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,325 | 🐛 73 | 🌐 TypeScript | 📅 2026-03-20 styles.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,092 | 🐛 1,186 | 🌐 JavaScript | 📅 2026-03-20 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,275 | 🐛 340 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for React and JSX.
  ...
  * [React Refresh](https://github.com/ArnaudBarre/eslint-plugin-react-refresh) ⭐ 330 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-23 - Improve HMR experience when using Vite.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,774 | 🐛 363 | 🌐 JavaScript | 📅 2026-03-20 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 205 | 🌐 TypeScript | 📅 2026-03-16 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 108 | 🐛 15 | 🌐 TypeScript | 📅 2026-03-19 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,779 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-20 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,699 | 🐛 77 | 📅 2022-05-19.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 394 | 🐛 134 | 🌐 TypeScript | 📅 2026-03-19 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 170 | 🌐 JavaScript | 📅 2026-03-21 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,909 | 🐛 754 | 🌐 TypeScript | 📅 2026-03-20 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 228 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-20 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-20 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 733 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 781 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-19 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 781 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-19 linter into ESLint.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 806 | 🐛 18 | 🌐 TypeScript | 📅 2026-03-20 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 678 | 🐛 73 | 🌐 TypeScript | 📅 2026-03-16 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 95 | 🐛 10 | 🌐 JavaScript | 📅 2026-03-11 - Avoid redundancy when using es2015 array methods and functions.
...
* [new-with-error](https://github.com/Trott/eslint-plugin-new-with-error) ⭐ 26 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-13 - Require errors to be thrown using `new`.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 758 | 🐛 18 | 🌐 TypeScript | 📅 2026-03-19 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 11 | 🐛 10 | 🌐 TypeScript | 📅 2026-03-19 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [no-unsanitized](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 241 | 🐛 32 | 🌐 JavaScript | 📅 2026-03-09 - Checks for `innerHTML`, `outerHTML`, etc.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,842 | 🐛 7 | 🌐 TypeScript | 📅 2026-03-17 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,049 | 🐛 34 | 🌐 TypeScript | 📅 2026-03-20 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 725 | 🐛 26 | 🌐 JavaScript | 📅 2026-03-18 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 377 | 🐛 2 | 🌐 TypeScript | 📅 2026-03-18 - Linting rules for Playwright.
* Mocha
...
* [QUnit](https://github.com/platinumazure/eslint-plugin-qunit) ⭐ 31 | 🐛 35 | 🌐 JavaScript | 📅 2026-03-14 - Linting rules for QUnit.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,909 | 🐛 754 | 🌐 TypeScript | 📅 2026-03-20 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,811 | 🐛 2,373 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 107 | 🐛 46 | 🌐 TypeScript | 📅 2026-03-12 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
