...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,104 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,104 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,066 | 🐛 104 | 🌐 JavaScript | 📅 2026-02-21 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Canonical](https://github.com/gajus/eslint-config-canonical) ⭐ 622 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-26 - Shareable config for [Canonical style guide](https://github.com/gajus/canonical) ⭐ 18 | 🐛 6 | 🌐 JavaScript | 📅 2017-01-11.
...
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-19 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,431 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,952 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10.

### Other Configs

* [Hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) ⭐ 462 | 🐛 46 | 🌐 JavaScript | 📅 2026-01-22 - The most strict (but practical) ESLint config out there.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,952 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10 - JavaScript happiness style linter ❤️.
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,854 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-14 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,931 | 🐛 384 | 🌐 JavaScript | 📅 2026-02-19 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,198 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-20 - Rules detecting bugs and suspicious patterns.
* [depend](https://github.com/es-tooling/eslint-plugin-depend) ⭐ 474 | 🐛 8 | 🌐 TypeScript | 📅 2025-11-12 - Helps detect dependency tree bloat and redundant polyfills.
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 326 | 🐛 13 | 🌐 JavaScript | 📅 2026-02-09 - Misc. rules from GitHub.
* [De Morgan](https://github.com/azat-io/eslint-plugin-de-morgan) ⭐ 305 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-19 - Transforms logical expressions in code to make them easier to understand.
...
* [Compat](https://github.com/amilajack/eslint-plugin-compat) ⭐ 3,164 | 🐛 86 | 🌐 TypeScript | 📅 2026-02-18 - Lint browser compatibility of APIs used ([caniuse](http://caniuse.com/#search=fetch) as an ESLint plugin).
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 148 | 🐛 3 | 🌐 JavaScript | 📅 2026-02-19 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,001 | 🐛 368 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
* [CSS-modules](https://github.com/atfzl/eslint-plugin-css-modules) ⭐ 155 | 🐛 33 | 🌐 JavaScript | 📅 2024-11-29 - Lint undefined or unused rules for css modules.
* Styled Components
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,302 | 🐛 88 | 🌐 TypeScript | 📅 2025-12-28 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 541 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-20 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,249 | 🐛 1,139 | 🌐 JavaScript | 📅 2026-02-21 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,263 | 🐛 348 | 🌐 JavaScript | 📅 2026-02-19 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,562 | 🐛 124 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
  ...
  * [React Refresh](https://github.com/ArnaudBarre/eslint-plugin-react-refresh) ⭐ 325 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-01 - Improve HMR experience when using Vite.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,783 | 🐛 354 | 🌐 JavaScript | 📅 2026-02-20 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 205 | 🌐 JavaScript | 📅 2026-02-19 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 107 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-20 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,774 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-20 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 620 | 🐛 74 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,717 | 🐛 78 | 📅 2022-05-19.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 401 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-20 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 391 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-20 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 184 | 🌐 JavaScript | 📅 2026-02-21 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,884 | 🐛 761 | 🌐 TypeScript | 📅 2026-02-20 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [N](https://github.com/eslint-community/eslint-plugin-n) ⭐ 325 | 🐛 50 | 🌐 JavaScript | 📅 2026-02-20 - Additional ESLint's rules for Node.js. Properly maintained fork of no longer maintained `eslint-plugin-node`.
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-20 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 255 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-21 - ESLint plugin for HTML.
* JSON
  * [JSON with Comments](https://github.com/ota-meshi/eslint-plugin-jsonc) ⭐ 231 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-21 - ESLint plugin for JSON, JSONC and JSON5.
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 224 | 🐛 38 | 🌐 TypeScript | 📅 2026-02-21 - Rules for consistent, readable, and valid package.json files.
  * [JSON](https://github.com/azeemba/eslint-plugin-json) ⭐ 216 | 🐛 19 | 🌐 JavaScript | 📅 2024-08-14 - Lint your JSON files.
  * [JSON Schema](https://github.com/ota-meshi/eslint-plugin-json-schema-validator) ⭐ 91 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-21 - Validates data defined in JavaScript, JSON, YAML and TOML using JSON Schema Validator.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 228 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-20 - An ESLint plugin for linting ESLint plugins.
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 173 | 🐛 14 | 🌐 TypeScript | 📅 2026-02-20 - ESLint plugin for YAML.
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 118 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-20 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-19 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
* [SQL](https://github.com/gajus/eslint-plugin-sql) ⭐ 111 | 🐛 4 | 🌐 TypeScript | 📅 2026-01-12 - SQL linting rules for ESLint.
* [TOML](https://github.com/ota-meshi/eslint-plugin-toml) ⭐ 32 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-21 - ESLint plugin for TOML.

### Libraries

* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,049 | 🐛 133 | 🌐 JavaScript | 📅 2025-09-15 - Linting rules for Tailwind CSS classnames.
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-02-20 - Check your GraphQL query strings against a schema.
  * [dotansimha/graphql-eslint](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-20 - Validates, prettifies and checks your GraphQL operations and GraphQL schema for best-practices.
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,199 | 🐛 34 | 🌐 JavaScript | 📅 2026-02-20 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 691 | 🐛 18 | 🌐 TypeScript | 📅 2026-02-15 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
  ...
  * [Lodash template](https://github.com/ota-meshi/eslint-plugin-lodash-template) ⭐ 17 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-19 - Plugin for Lodash template/Underscore template.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-20 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-20 linter into ESLint.
* [Diff](https://github.com/paleite/eslint-plugin-diff) ⭐ 209 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-18 - Run ESLint on your changed lines only. Also supports CI!
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,874 | 🐛 593 | 🌐 JavaScript | 📅 2026-02-19 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [fp](https://github.com/jfmengels/eslint-plugin-fp) ⭐ 972 | 🐛 31 | 🌐 JavaScript | 📅 2021-01-01 - ESLint rules for functional programming.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 962 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-20 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 791 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-03 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 654 | 🐛 72 | 🌐 TypeScript | 📅 2026-02-20 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 96 | 🐛 10 | 🌐 JavaScript | 📅 2026-02-20 - Avoid redundancy when using es2015 array methods and functions.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-20 - ESLint plugin related to Math object and Number.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 757 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-20 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 12 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-17 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,322 | 🐛 13 | 🌐 JavaScript | 📅 2026-02-19 - ESLint rules for Node Security.
* [no-unsanitized](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 240 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-20 - Checks for `innerHTML`, `outerHTML`, etc.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,816 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-18 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,409 | 🐛 8 | 🌐 JavaScript | 📅 2026-01-22 - Easy autofixable import sorting.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,166 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-16 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,046 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-20 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 373 | 🐛 5 | 🌐 TypeScript | 📅 2026-02-20 - Linting rules for Playwright.
* Mocha
  * [Enforcing practices](https://github.com/lo1tuma/eslint-plugin-mocha) ⭐ 289 | 🐛 28 | 🌐 TypeScript | 📅 2025-10-13 - Linting rules for Mocha.
  * [Enforcing manageability](https://github.com/onechiporenko/eslint-plugin-mocha-cleanup/) ⭐ 13 | 🐛 14 | 🌐 JavaScript | 📅 2026-02-18
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,884 | 🐛 761 | 🌐 TypeScript | 📅 2026-02-20 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
* [GraphQL](https://github.com/dotansimha/graphql-eslint) ⭐ 833 | 🐛 67 | 🌐 TypeScript | 📅 2026-02-20 - Parser for the GraphQL AST. Includes parser, plugin, processor (for non-graphql files) and rules.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,923 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
* [ES and browser globals](https://github.com/sindresorhus/globals) ⭐ 559 | 🐛 8 | 🌐 JavaScript | 📅 2026-02-01 (originally from ESLint)
...
* [esprint](https://github.com/pinterest/esprint) ⭐ 656 | 🐛 22 | 🌐 JavaScript | 📅 2026-02-19 - Run ESLint across multiple threads.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 245 | 🐛 2 | 🌐 JavaScript | 📅 2026-02-07 - Generate ESLint
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-20 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [eslint-multiplexer](https://github.com/pimlie/eslint-multiplexer) ⭐ 7 | 🐛 11 | 🌐 JavaScript | 📅 2026-02-17 - Multiplex eslint results and merge results for common files.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 106 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-19 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
* [eslint-docgen](https://github.com/wikimedia/eslint-docgen) ⭐ 11 | 🐛 14 | 🌐 JavaScript | 📅 2026-02-20 - Automatically generate ESLint plugin documentation from rule metadata and test cases.
