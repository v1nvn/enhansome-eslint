...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,884 | 🐛 94 | 🌐 JavaScript | 📅 2026-02-09 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,044 | 🐛 51 | 🌐 JavaScript | 📅 2026-02-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-07 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,429 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,915 | 🐛 409 | 🌐 JavaScript | 📅 2026-02-11 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,198 | 🐛 9 | 🌐 TypeScript | 📅 2026-02-12 - Rules detecting bugs and suspicious patterns.
* [depend](https://github.com/es-tooling/eslint-plugin-depend) ⭐ 472 | 🐛 8 | 🌐 TypeScript | 📅 2025-11-12 - Helps detect dependency tree bloat and redundant polyfills.
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 326 | 🐛 13 | 🌐 JavaScript | 📅 2026-02-09 - Misc. rules from GitHub.
* [De Morgan](https://github.com/azat-io/eslint-plugin-de-morgan) ⭐ 304 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-07 - Transforms logical expressions in code to make them easier to understand.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 539 | 🐛 22 | 🌐 JavaScript | 📅 2026-02-11 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 242,950 | 🐛 1,112 | 🌐 JavaScript | 📅 2026-02-11 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,257 | 🐛 366 | 🌐 JavaScript | 📅 2026-02-10 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,778 | 🐛 337 | 🌐 JavaScript | 📅 2026-02-11 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,601 | 🐛 213 | 🌐 JavaScript | 📅 2026-02-10 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,773 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-12 - Linting rules for Angular (v2+).
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,878 | 🐛 757 | 🌐 TypeScript | 📅 2026-02-11 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 251 | 🐛 31 | 🌐 JavaScript | 📅 2026-02-11 - ESLint plugin for HTML.
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 224 | 🐛 38 | 🌐 TypeScript | 📅 2026-02-10 - Rules for consistent, readable, and valid package.json files.
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,197 | 🐛 33 | 🌐 JavaScript | 📅 2026-02-07 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 679 | 🐛 21 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-11 linter into ESLint.
* [Diff](https://github.com/paleite/eslint-plugin-diff) ⭐ 208 | 🐛 26 | 🌐 TypeScript | 📅 2026-01-22 - Run ESLint on your changed lines only. Also supports CI!
...
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 961 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-12 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 646 | 🐛 68 | 🌐 TypeScript | 📅 2025-10-29 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 756 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,322 | 🐛 15 | 🌐 JavaScript | 📅 2026-02-12 - ESLint rules for Node Security.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,813 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-11 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Chai
  ...
  * [expect practices](https://github.com/turbo87/eslint-plugin-chai-expect) ⭐ 28 | 🐛 18 | 🌐 JavaScript | 📅 2026-02-04
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,878 | 🐛 757 | 🌐 TypeScript | 📅 2026-02-11 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,940 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [esprint](https://github.com/pinterest/esprint) ⭐ 657 | 🐛 21 | 🌐 JavaScript | 📅 2025-06-13 - Run ESLint across multiple threads.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-11 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [codacy-eslint](https://github.com/codacy/codacy-eslint) ⭐ 16 | 🐛 44 | 🌐 TypeScript | 📅 2026-02-11 - Docker used at [Codacy](https://www.codacy.com) to run ESLint.
...
* [eslint-disable-autofix](https://github.com/MorevM/eslint-disable-autofix/) ⭐ 2 | 🐛 0 | 🌐 TypeScript | 📅 2026-02-11 - Utility to disable autofix for specific ESLint rules.
