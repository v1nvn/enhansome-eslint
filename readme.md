...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,226 | 🐛 111 | 🌐 JavaScript | 📅 2026-05-07 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,173 | 🐛 54 | 🌐 JavaScript | 📅 2026-04-30 - Anthony's ESLint config preset.
...
* [Cecilia](https://github.com/SandroMiguel/eslint-config-cecilia) ⭐ 7 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-06 - ESLint configuration for awesome projects.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,843 | 🐛 1,281 | 🌐 JavaScript | 📅 2026-05-07 - Linting rules for React Hooks.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,773 | 🐛 364 | 🌐 JavaScript | 📅 2026-05-06 - Meteor specific linting rules for ESLint.
* Vue
...
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,665 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 426 | 🐛 32 | 🌐 TypeScript | 📅 2026-05-07 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,897 | 🐛 752 | 🌐 TypeScript | 📅 2026-05-06 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 236 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-07 - Rules for consistent, readable, and valid package.json files.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 787 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-06 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-06 linter into ESLint.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 9 | 🌐 TypeScript | 📅 2026-05-06 - ESLint plugin related to Math object and Number.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,897 | 🐛 752 | 🌐 TypeScript | 📅 2026-05-06 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,397 | 🐛 2,377 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [generator-eslint](https://github.com/eslint/generator-eslint) ⭐ 245 | 🐛 2 | 🌐 JavaScript | 📅 2026-05-06 - Generate ESLint
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-06 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [codacy-eslint](https://github.com/codacy/codacy-eslint) ⭐ 16 | 🐛 47 | 🌐 TypeScript | 📅 2026-05-04 - Docker used at [Codacy](https://www.codacy.com) to run ESLint.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 108 | 🐛 49 | 🌐 TypeScript | 📅 2026-04-23 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
