...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,904 | 🐛 93 | 🌐 JavaScript | 📅 2026-02-16 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,049 | 🐛 54 | 🌐 JavaScript | 📅 2026-02-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-15 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,428 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,950 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,950 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10 - JavaScript happiness style linter ❤️.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,927 | 🐛 385 | 🌐 JavaScript | 📅 2026-02-15 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,198 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-16 - Rules detecting bugs and suspicious patterns.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,030 | 🐛 1,121 | 🌐 JavaScript | 📅 2026-02-16 - Linting rules for React Hooks.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,785 | 🐛 341 | 🌐 JavaScript | 📅 2026-02-16 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,600 | 🐛 205 | 🌐 JavaScript | 📅 2026-02-16 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 107 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-16 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,774 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-16 - Linting rules for Angular (v2+).
...
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 176 | 🌐 JavaScript | 📅 2026-02-17 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,876 | 🐛 753 | 🌐 TypeScript | 📅 2026-02-15 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-13 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 253 | 🐛 31 | 🌐 JavaScript | 📅 2026-02-16 - ESLint plugin for HTML.
* JSON
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 226 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-16 - An ESLint plugin for linting ESLint plugins.
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 173 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-16 - ESLint plugin for YAML.
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-16 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,046 | 🐛 133 | 🌐 JavaScript | 📅 2025-09-15 - Linting rules for Tailwind CSS classnames.
* GraphQL
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 687 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-15 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-16 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-16 linter into ESLint.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 652 | 🐛 73 | 🌐 TypeScript | 📅 2025-10-29 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 757 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-16 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,813 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-13 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,167 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-16 - Linting rules for Jest.
...
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-16 - Linting rules for Cypress.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,876 | 🐛 753 | 🌐 TypeScript | 📅 2026-02-15 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,932 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-16 - CLI tool for testing given ESlint rules against multiple repositories at once.
