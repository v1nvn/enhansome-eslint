...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,099 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,099 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,954 | 🐛 94 | 🌐 JavaScript | 📅 2026-02-18 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-17 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,432 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
...
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,853 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-14 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,929 | 🐛 386 | 🌐 JavaScript | 📅 2026-02-15 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,198 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-18 - Rules detecting bugs and suspicious patterns.
...
* [Compat](https://github.com/amilajack/eslint-plugin-compat) ⭐ 3,163 | 🐛 86 | 🌐 TypeScript | 📅 2026-02-18 - Lint browser compatibility of APIs used ([caniuse](http://caniuse.com/#search=fetch) as an ESLint plugin).
* [es-x](https://github.com/eslint-community/eslint-plugin-es-x) ⭐ 148 | 🐛 4 | 🌐 JavaScript | 📅 2026-02-07 - Disable specific ECMAScript language versions or individual features. Properly maintained fork of no longer maintained `eslint-plugin-es`.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,115 | 🐛 1,127 | 🌐 JavaScript | 📅 2026-02-18 - Linting rules for React Hooks.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,788 | 🐛 349 | 🌐 JavaScript | 📅 2026-02-18 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 206 | 🌐 JavaScript | 📅 2026-02-16 - Plugin for VueJS.
...
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 400 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-17 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 391 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-17 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 191 | 🌐 JavaScript | 📅 2026-02-19 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,876 | 🐛 755 | 🌐 TypeScript | 📅 2026-02-17 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-17 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 254 | 🐛 31 | 🌐 JavaScript | 📅 2026-02-18 - ESLint plugin for HTML.
* JSON
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 226 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-17 - An ESLint plugin for linting ESLint plugins.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-18 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,199 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-18 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 690 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-15 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
  ...
  * [Lodash template](https://github.com/ota-meshi/eslint-plugin-lodash-template) ⭐ 17 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-17 - Plugin for Lodash template/Underscore template.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-18 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-18 linter into ESLint.
...
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 962 | 🐛 12 | 🌐 TypeScript | 📅 2026-02-18 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 787 | 🐛 31 | 🌐 TypeScript | 📅 2026-02-03 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 652 | 🐛 73 | 🌐 TypeScript | 📅 2026-02-17 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 96 | 🐛 10 | 🌐 JavaScript | 📅 2026-02-16 - Avoid redundancy when using es2015 array methods and functions.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-18 - ESLint plugin related to Math object and Number.
...
* [Security](https://github.com/nodesecurity/eslint-plugin-security) ⭐ 2,322 | 🐛 14 | 🌐 JavaScript | 📅 2026-02-17 - ESLint rules for Node Security.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,814 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-18 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,045 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-17 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 371 | 🐛 5 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Playwright.
* Mocha
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,876 | 🐛 755 | 🌐 TypeScript | 📅 2026-02-17 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,924 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 106 | 🐛 43 | 🌐 TypeScript | 📅 2026-02-15 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
