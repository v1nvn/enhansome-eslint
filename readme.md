...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,120 | 🐛 159 | 🌐 JavaScript | 📅 2026-04-16 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,120 | 🐛 159 | 🌐 JavaScript | 📅 2026-04-16.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,215 | 🐛 110 | 🌐 JavaScript | 📅 2026-04-28 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Wikimedia](https://github.com/wikimedia/eslint-config-wikimedia) ⭐ 34 | 🐛 37 | 🌐 JavaScript | 📅 2026-04-29 - Shareable config for [Wikimedia's style guide](https://www.mediawiki.org/wiki/Manual:Coding_conventions/JavaScript), used by [MediaWiki](https://www.mediawiki.org/).
...
* [Canonical](https://github.com/gajus/eslint-config-canonical) ⭐ 624 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-05 - Shareable config for [Canonical style guide](https://github.com/gajus/canonical) ⭐ 19 | 🐛 6 | 🌐 JavaScript | 📅 2017-01-11.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,166 | 🐛 53 | 🌐 JavaScript | 📅 2026-04-28 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,655 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-29 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,437 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 285 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-04 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,969 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02.
...
* [Problems](https://github.com/RyanZim/eslint-config-problems) ⭐ 66 | 🐛 1 | 🌐 JavaScript | 📅 2026-04-09 - Shareable config that only catches actual problems, and doesn't enforce stylistic preferences.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,969 | 🐛 6 | 🌐 TypeScript | 📅 2026-04-02 - JavaScript happiness style linter ❤️.
...
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,230 | 🐛 19 | 🌐 TypeScript | 📅 2026-04-30 - Rules detecting bugs and suspicious patterns.
...
* [Compat](https://github.com/amilajack/eslint-plugin-compat) ⭐ 3,166 | 🐛 87 | 🌐 TypeScript | 📅 2026-04-29 - Lint browser compatibility of APIs used ([caniuse](http://caniuse.com/#search=fetch) as an ESLint plugin).
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-29 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,365 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-22 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 566 | 🐛 14 | 🌐 JavaScript | 📅 2026-04-29 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,766 | 🐛 1,261 | 🌐 JavaScript | 📅 2026-04-29 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,279 | 🐛 348 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,579 | 🐛 131 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,767 | 🐛 355 | 🌐 JavaScript | 📅 2026-04-29 - Meteor specific linting rules for ESLint.
* Vue
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,782 | 🐛 43 | 🌐 TypeScript | 📅 2026-04-29 - Linting rules for Angular (v2+).
...
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 423 | 🐛 29 | 🌐 TypeScript | 📅 2026-04-30 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 402 | 🐛 128 | 🌐 TypeScript | 📅 2026-04-29 - Linting rules for Svelte v3 Components.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,897 | 🐛 752 | 🌐 TypeScript | 📅 2026-04-29 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [N](https://github.com/eslint-community/eslint-plugin-n) ⭐ 330 | 🐛 41 | 🌐 JavaScript | 📅 2026-04-30 - Additional ESLint's rules for Node.js. Properly maintained fork of no longer maintained `eslint-plugin-node`.
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 299 | 🐛 24 | 🌐 TypeScript | 📅 2026-04-29 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 261 | 🐛 25 | 🌐 JavaScript | 📅 2026-04-29 - ESLint plugin for HTML.
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 234 | 🐛 33 | 🌐 TypeScript | 📅 2026-04-29 - Rules for consistent, readable, and valid package.json files.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 232 | 🐛 39 | 🌐 TypeScript | 📅 2026-04-29 - An ESLint plugin for linting ESLint plugins.
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 178 | 🐛 14 | 🌐 TypeScript | 📅 2026-04-30 - ESLint plugin for YAML.
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 120 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-29 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
...
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-04-29 - Check your GraphQL query strings against a schema.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 764 | 🐛 19 | 🌐 TypeScript | 📅 2026-04-28 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [jQuery](https://github.com/wikimedia/eslint-plugin-no-jquery) ⭐ 32 | 🐛 19 | 🌐 JavaScript | 📅 2026-04-29 - Linting rules for jQuery, including versioned configs for deprecated features.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 786 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-29 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 786 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-29 linter into ESLint.
...
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 975 | 🐛 10 | 🌐 TypeScript | 📅 2026-04-29 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 873 | 🐛 17 | 🌐 TypeScript | 📅 2026-04-29 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 11 | 🐛 11 | 🌐 TypeScript | 📅 2026-04-29 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,859 | 🐛 4 | 🌐 TypeScript | 📅 2026-04-29 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,166 | 🐛 25 | 🌐 TypeScript | 📅 2026-04-29 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 36 | 🌐 TypeScript | 📅 2026-04-29 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 726 | 🐛 25 | 🌐 JavaScript | 📅 2026-04-29 - Linting rules for Cypress.
* Vitest
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,897 | 🐛 752 | 🌐 TypeScript | 📅 2026-04-29 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,465 | 🐛 2,378 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-29 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [eslint-multiplexer](https://github.com/pimlie/eslint-multiplexer) ⭐ 7 | 🐛 14 | 🌐 JavaScript | 📅 2026-04-29 - Multiplex eslint results and merge results for common files.
