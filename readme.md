...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,103 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,103 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,009 | 🐛 98 | 🌐 JavaScript | 📅 2026-02-19 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-19 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,433 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,951 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,951 | 🐛 64 | 🌐 TypeScript | 📅 2026-02-10 - JavaScript happiness style linter ❤️.
...
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,198 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-19 - Rules detecting bugs and suspicious patterns.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,003 | 🐛 368 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 539 | 🐛 20 | 🌐 JavaScript | 📅 2026-02-18 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,185 | 🐛 1,126 | 🌐 JavaScript | 📅 2026-02-19 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,262 | 🐛 348 | 🌐 JavaScript | 📅 2026-02-19 - Linting rules for React and JSX.
  ...
  * [React Refresh](https://github.com/ArnaudBarre/eslint-plugin-react-refresh) ⭐ 325 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-01 - Improve HMR experience when using Vite.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,785 | 🐛 353 | 🌐 JavaScript | 📅 2026-02-18 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 205 | 🌐 JavaScript | 📅 2026-02-19 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 107 | 🐛 20 | 🌐 TypeScript | 📅 2026-02-17 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,774 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Angular (v2+).
...
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 401 | 🐛 23 | 🌐 TypeScript | 📅 2026-02-17 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 391 | 🐛 129 | 🌐 TypeScript | 📅 2026-02-19 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 182 | 🌐 JavaScript | 📅 2026-02-20 - Linting rules for Ember.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,878 | 🐛 759 | 🌐 TypeScript | 📅 2026-02-20 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [N](https://github.com/eslint-community/eslint-plugin-n) ⭐ 325 | 🐛 50 | 🌐 JavaScript | 📅 2026-02-18 - Additional ESLint's rules for Node.js. Properly maintained fork of no longer maintained `eslint-plugin-node`.
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 297 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-19 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 255 | 🐛 30 | 🌐 JavaScript | 📅 2026-02-19 - ESLint plugin for HTML.
* JSON
  * [JSON with Comments](https://github.com/ota-meshi/eslint-plugin-jsonc) ⭐ 231 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-19 - ESLint plugin for JSON, JSONC and JSON5.
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 224 | 🐛 39 | 🌐 TypeScript | 📅 2026-02-18 - Rules for consistent, readable, and valid package.json files.
  * [JSON](https://github.com/azeemba/eslint-plugin-json) ⭐ 216 | 🐛 19 | 🌐 JavaScript | 📅 2024-08-14 - Lint your JSON files.
  * [JSON Schema](https://github.com/ota-meshi/eslint-plugin-json-schema-validator) ⭐ 91 | 🐛 11 | 🌐 TypeScript | 📅 2026-02-19 - Validates data defined in JavaScript, JSON, YAML and TOML using JSON Schema Validator.
...
* [eslint-plugin-eslint-plugin](https://github.com/not-an-aardvark/eslint-plugin-eslint-plugin) ⭐ 228 | 🐛 35 | 🌐 TypeScript | 📅 2026-02-17 - An ESLint plugin for linting ESLint plugins.
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 173 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-18 - ESLint plugin for YAML.
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 118 | 🐛 19 | 🌐 TypeScript | 📅 2026-02-17 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
...
* [TOML](https://github.com/ota-meshi/eslint-plugin-toml) ⭐ 32 | 🐛 2 | 🌐 TypeScript | 📅 2026-02-18 - ESLint plugin for TOML.
...
* GraphQL
  * [apollostack/eslint-plugin-graphql](https://github.com/apollostack/eslint-plugin-graphql) ⭐ 1,216 | 🐛 100 | 🌐 JavaScript | 📅 2026-02-17 - Check your GraphQL query strings against a schema.
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,199 | 🐛 35 | 🌐 JavaScript | 📅 2026-02-19 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-19 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-19 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,872 | 🐛 593 | 🌐 JavaScript | 📅 2026-02-19 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [fp](https://github.com/jfmengels/eslint-plugin-fp) ⭐ 972 | 🐛 31 | 🌐 JavaScript | 📅 2021-01-01 - ESLint rules for functional programming.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 962 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-19 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 788 | 🐛 30 | 🌐 TypeScript | 📅 2026-02-03 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 653 | 🐛 74 | 🌐 TypeScript | 📅 2026-02-17 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [array-func](https://github.com/freaktechnik/eslint-plugin-array-func) ⭐ 96 | 🐛 11 | 🌐 JavaScript | 📅 2026-02-19 - Avoid redundancy when using es2015 array methods and functions.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 5 | 🌐 TypeScript | 📅 2026-02-20 - ESLint plugin related to Math object and Number.
...
* [Promise](https://github.com/xjamundx/eslint-plugin-promise) ⭐ 986 | 🐛 50 | 🌐 JavaScript | 📅 2026-02-12 - Best practices when working with promises.
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 757 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-17 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [no-unsanitized](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 240 | 🐛 36 | 🌐 JavaScript | 📅 2026-02-19 - Checks for `innerHTML`, `outerHTML`, etc.
...
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,409 | 🐛 9 | 🌐 JavaScript | 📅 2026-01-22 - Easy autofixable import sorting.
...
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 23 | 🌐 JavaScript | 📅 2026-02-17 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 372 | 🐛 5 | 🌐 TypeScript | 📅 2026-02-18 - Linting rules for Playwright.
* Mocha
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,878 | 🐛 759 | 🌐 TypeScript | 📅 2026-02-20 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,921 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
* [ES and browser globals](https://github.com/sindresorhus/globals) ⭐ 558 | 🐛 8 | 🌐 JavaScript | 📅 2026-02-01 (originally from ESLint)
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-17 - CLI tool for testing given ESlint rules against multiple repositories at once.
