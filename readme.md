...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,102 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,102 | 🐛 185 | 🌐 JavaScript | 📅 2025-11-06.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 26,881 | 🐛 92 | 🌐 JavaScript | 📅 2026-02-09 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,041 | 🐛 51 | 🌐 JavaScript | 📅 2026-02-10 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,651 | 🐛 29 | 🌐 TypeScript | 📅 2026-02-07 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,434 | 🐛 128 | 🌐 JavaScript | 📅 2025-07-11.
...
* [eslint-config-prettier](https://github.com/prettier/eslint-config-prettier) ⭐ 5,850 | 🐛 16 | 🌐 JavaScript | 📅 2026-02-04 - Prettier config for ESlint maintained by Prettier team.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,912 | 🐛 415 | 🌐 JavaScript | 📅 2026-02-09 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,199 | 🐛 8 | 🌐 TypeScript | 📅 2026-02-10 - Rules detecting bugs and suspicious patterns.
...
* [Compat](https://github.com/amilajack/eslint-plugin-compat) ⭐ 3,162 | 🐛 87 | 🌐 TypeScript | 📅 2026-01-23 - Lint browser compatibility of APIs used ([caniuse](http://caniuse.com/#search=fetch) as an ESLint plugin).
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 31 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,299 | 🐛 88 | 🌐 TypeScript | 📅 2025-12-28 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 539 | 🐛 22 | 🌐 JavaScript | 📅 2026-02-08 - Linting for JavaScript inside of Markdown.
* [HTML](https://github.com/BenoitZugmeyer/eslint-plugin-html) ⭐ 452 | 🐛 18 | 🌐 JavaScript | 📅 2026-02-09 - Linting for JavaScript inside of HTML `<script>` tags.

### Frameworks

* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 242,899 | 🐛 1,116 | 🌐 JavaScript | 📅 2026-02-09 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,256 | 🐛 365 | 🌐 JavaScript | 📅 2026-02-10 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,563 | 🐛 123 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
  ...
  * [React Refresh](https://github.com/ArnaudBarre/eslint-plugin-react-refresh) ⭐ 322 | 🐛 7 | 🌐 TypeScript | 📅 2026-02-01 - Improve HMR experience when using Vite.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,773 | 🐛 331 | 🌐 JavaScript | 📅 2026-02-09 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,600 | 🐛 212 | 🌐 JavaScript | 📅 2026-02-09 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,772 | 🐛 36 | 🌐 TypeScript | 📅 2026-02-09 - Linting rules for Angular (v2+).
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 389 | 🐛 132 | 🌐 TypeScript | 📅 2026-02-08 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 173 | 🌐 JavaScript | 📅 2026-02-02 - Linting rules for Ember.
* [Solid](https://github.com/joshwilsonvu/eslint-plugin-solid) ⭐ 256 | 🐛 40 | 🌐 TypeScript | 📅 2026-01-29 - Linting rules for Solid and JSX.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,878 | 🐛 756 | 🌐 TypeScript | 📅 2026-02-06 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* JSON
  * [JSON with Comments](https://github.com/ota-meshi/eslint-plugin-jsonc) ⭐ 231 | 🐛 16 | 🌐 TypeScript | 📅 2026-02-10 - ESLint plugin for JSON, JSONC and JSON5.
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 222 | 🐛 38 | 🌐 TypeScript | 📅 2026-02-10 - Rules for consistent, readable, and valid package.json files.
...
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 172 | 🐛 13 | 🌐 TypeScript | 📅 2026-02-09 - ESLint plugin for YAML.
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-09 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 679 | 🐛 22 | 🌐 TypeScript | 📅 2026-02-02 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
  ...
  * [Lodash template](https://github.com/ota-meshi/eslint-plugin-lodash-template) ⭐ 17 | 🐛 12 | 🌐 JavaScript | 📅 2026-02-09 - Plugin for Lodash template/Underscore template.
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 781 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-09 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 781 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-09 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,871 | 🐛 593 | 🌐 JavaScript | 📅 2025-12-30 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [fp](https://github.com/jfmengels/eslint-plugin-fp) ⭐ 972 | 🐛 31 | 🌐 JavaScript | 📅 2021-01-01 - ESLint rules for functional programming.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 961 | 🐛 10 | 🌐 TypeScript | 📅 2026-02-10 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 643 | 🐛 68 | 🌐 TypeScript | 📅 2025-10-29 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
* [eslint-plugin-hexagonal-architecture](https://github.com/CodelyTV/eslint-plugin-hexagonal-architecture) ⭐ 312 | 🐛 3 | 🌐 TypeScript | 📅 2022-09-23 - A plugin that helps you to enforce hexagonal architecture best practices.
...
* [new-with-error](https://github.com/Trott/eslint-plugin-new-with-error) ⭐ 26 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-09 - Require errors to be thrown using `new`.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 4 | 🌐 TypeScript | 📅 2026-02-09 - ESLint plugin related to Math object and Number.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 755 | 🐛 17 | 🌐 TypeScript | 📅 2026-02-09 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [no-unsanitized](https://github.com/mozilla/eslint-plugin-no-unsanitized) ⭐ 240 | 🐛 37 | 🌐 JavaScript | 📅 2025-09-05 - Checks for `innerHTML`, `outerHTML`, etc.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,809 | 🐛 6 | 🌐 TypeScript | 📅 2026-02-08 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,167 | 🐛 25 | 🌐 TypeScript | 📅 2026-02-09 - Linting rules for Jest.
...
* [AVA](https://github.com/avajs/eslint-plugin-ava) ⭐ 230 | 🐛 0 | 🌐 JavaScript | 📅 2026-02-09 - Linting rules for AVA.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,878 | 🐛 756 | 🌐 TypeScript | 📅 2026-02-06 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,945 | 🐛 2,367 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 131 | 🐛 3 | 🌐 TypeScript | 📅 2026-02-09 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [eslint-disable-autofix](https://github.com/MorevM/eslint-disable-autofix/) ⭐ 2 | 🐛 15 | 🌐 TypeScript | 📅 2026-02-09 - Utility to disable autofix for specific ESLint rules.
