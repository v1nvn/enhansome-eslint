...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,181 | 🐛 104 | 🌐 JavaScript | 📅 2026-03-13 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 282 | 🐛 1 | 🌐 JavaScript | 📅 2026-02-07 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,951 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-13.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,951 | 🐛 43 | 🌐 TypeScript | 📅 2026-03-13 - JavaScript happiness style linter ❤️.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 4,949 | 🐛 376 | 🌐 JavaScript | 📅 2026-03-05 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,205 | 🐛 22 | 🌐 TypeScript | 📅 2026-03-13 - Rules detecting bugs and suspicious patterns.
...
* [GitHub](https://github.com/github/eslint-plugin-github) ⭐ 328 | 🐛 20 | 🌐 JavaScript | 📅 2026-03-10 - Misc. rules from GitHub.
...
* [Emotion](https://github.com/emotion-js/emotion/tree/master/packages/eslint-plugin) ⭐ 18,006 | 🐛 371 | 🌐 JavaScript | 📅 2025-11-04 - ESLint rules for emotion.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 32 | 🐛 1 | 🌐 TypeScript | 📅 2025-12-01 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,321 | 🐛 88 | 🌐 TypeScript | 📅 2026-02-22 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 543 | 🐛 18 | 🌐 JavaScript | 📅 2026-03-13 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 243,906 | 🐛 1,171 | 🌐 JavaScript | 📅 2026-03-13 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,271 | 🐛 339 | 🌐 JavaScript | 📅 2026-03-11 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,779 | 🐛 371 | 🌐 JavaScript | 📅 2026-03-13 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,599 | 🐛 206 | 🌐 TypeScript | 📅 2026-03-13 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 108 | 🐛 14 | 🌐 TypeScript | 📅 2026-03-13 - Plugin for Scoped CSS in VueJS.
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,778 | 🐛 33 | 🌐 TypeScript | 📅 2026-03-14 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,706 | 🐛 77 | 📅 2022-05-19.
...
* [Svelte](https://github.com/sveltejs/eslint-plugin-svelte) ⭐ 393 | 🐛 136 | 🌐 TypeScript | 📅 2026-03-13 - Linting rules for Svelte v3 Components.
* [Ember](https://github.com/ember-cli/eslint-plugin-ember) ⭐ 261 | 🐛 167 | 🌐 JavaScript | 📅 2026-03-13 - Linting rules for Ember.
...
* JSON
  ...
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 225 | 🐛 25 | 🌐 TypeScript | 📅 2026-03-13 - Rules for consistent, readable, and valid package.json files.
...
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  * [eslint-plugin-expect-type](https://github.com/JoshuaKGoldberg/eslint-plugin-expect-type) ⭐ 118 | 🐛 20 | 🌐 TypeScript | 📅 2026-03-13 - Provides Twoslash, $ExpectError, and $ExpectType type assertions.
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 16 | 🌐 TypeScript | 📅 2026-03-13 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,052 | 🐛 136 | 🌐 JavaScript | 📅 2025-09-15 - Linting rules for Tailwind CSS classnames.
* GraphQL
...
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 719 | 🐛 21 | 🌐 TypeScript | 📅 2026-03-05 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-13 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 782 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-13 linter into ESLint.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,882 | 🐛 596 | 🌐 JavaScript | 📅 2026-03-05 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 801 | 🐛 32 | 🌐 TypeScript | 📅 2026-03-13 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 675 | 🐛 71 | 🌐 TypeScript | 📅 2026-03-11 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 756 | 🐛 17 | 🌐 TypeScript | 📅 2026-03-13 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,836 | 🐛 6 | 🌐 TypeScript | 📅 2026-03-11 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
* [Simple import sort](https://github.com/lydell/eslint-plugin-simple-import-sort) ⭐ 2,416 | 🐛 8 | 🌐 JavaScript | 📅 2026-02-28 - Easy autofixable import sorting.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,048 | 🐛 34 | 🌐 TypeScript | 📅 2026-03-13 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 721 | 🐛 24 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for Cypress.
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 375 | 🐛 3 | 🌐 TypeScript | 📅 2026-03-12 - Linting rules for Playwright.
* Mocha
...
* [QUnit](https://github.com/platinumazure/eslint-plugin-qunit) ⭐ 31 | 🐛 34 | 🌐 JavaScript | 📅 2026-03-10 - Linting rules for QUnit.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,824 | 🐛 2,373 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
