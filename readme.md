...
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,230 | 🐛 108 | 🌐 JavaScript | 📅 2026-05-07 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,173 | 🐛 55 | 🌐 JavaScript | 📅 2026-04-30 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,655 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-05 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,439 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,010 | 🐛 374 | 🌐 JavaScript | 📅 2026-05-06 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,232 | 🐛 20 | 🌐 TypeScript | 📅 2026-05-07 - Rules detecting bugs and suspicious patterns.
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-29 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,371 | 🐛 80 | 🌐 TypeScript | 📅 2026-04-22 styles.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,874 | 🐛 1,283 | 🌐 JavaScript | 📅 2026-05-07 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,279 | 🐛 351 | 🌐 JavaScript | 📅 2026-04-01 - Linting rules for React and JSX.
  * [JSX a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y) ⭐ 3,579 | 🐛 133 | 🌐 JavaScript | 📅 2026-01-06 - Accessibility rules on JSX elements.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,771 | 🐛 366 | 🌐 JavaScript | 📅 2026-05-07 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,596 | 🐛 206 | 🌐 TypeScript | 📅 2026-05-05 - Plugin for VueJS.
  * [VueJS Scoped CSS](https://github.com/future-architect/eslint-plugin-vue-scoped-css) ⭐ 108 | 🐛 19 | 🌐 TypeScript | 📅 2026-05-07 - Plugin for Scoped CSS in VueJS.
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,897 | 🐛 755 | 🌐 TypeScript | 📅 2026-05-08 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 300 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-07 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 261 | 🐛 29 | 🌐 JavaScript | 📅 2026-05-08 - ESLint plugin for HTML.
* JSON
  * [eslint-plugin-package-json](https://github.com/JoshuaKGoldberg/eslint-plugin-package-json) ⭐ 236 | 🐛 31 | 🌐 TypeScript | 📅 2026-05-08 - Rules for consistent, readable, and valid package.json files.
...
* [YAML](https://github.com/ota-meshi/eslint-plugin-yml) ⭐ 178 | 🐛 13 | 🌐 TypeScript | 📅 2026-05-07 - ESLint plugin for YAML.
* [TypeScript](https://typescript-eslint.io) - Linting rules for TypeScript.
  ...
  * [eslint-plugin-erasable-syntax-only](https://github.com/JoshuaKGoldberg/eslint-plugin-erasable-syntax-only) ⭐ 50 | 🐛 7 | 🌐 TypeScript | 📅 2026-05-07 - Granularly enforces TypeScript's erasableSyntaxOnly flag.
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,061 | 🐛 138 | 🌐 JavaScript | 📅 2026-04-24 - Linting rules for Tailwind CSS classnames.
* GraphQL
...
* [PutOut](https://github.com/coderaiser/putout/tree/master/packages/eslint-plugin-putout) ⭐ 787 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-08 - an ESLint plugin integrates [putout](https://github.com/coderaiser/putout) ⭐ 787 | 🐛 1 | 🌐 JavaScript | 📅 2026-05-08 linter into ESLint.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 880 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-06 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
* [import-x](https://github.com/un-ts/eslint-plugin-import-x) ⭐ 711 | 🐛 77 | 🌐 TypeScript | 📅 2026-03-16 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names. Lightweight fork of `eslint-plugin-import`, but which breaks backwards compatibility.
...
* [Math](https://github.com/ota-meshi/eslint-plugin-math) ⭐ 15 | 🐛 10 | 🌐 TypeScript | 📅 2026-05-07 - ESLint plugin related to Math object and Number.
...
* [eslint-plugin-hex-under](https://github.com/2nd-Labs/eslint-plugin-hex-under) ⭐ 0 | 🐛 0 | 🌐 JavaScript | 📅 2026-05-06 - A plugin to prove that a hexadecimal number is less than a specified value.
...
* [RegExp](https://github.com/ota-meshi/eslint-plugin-regexp) ⭐ 759 | 🐛 25 | 🌐 TypeScript | 📅 2026-05-07 - ESLint plugin for finding regexp mistakes and style guide violations.
...
* Jest
  * [Enforcing practices](https://github.com/jest-community/eslint-plugin-jest) ⭐ 1,166 | 🐛 27 | 🌐 TypeScript | 📅 2026-05-06 - Linting rules for Jest.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 40 | 🌐 TypeScript | 📅 2026-05-07 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 726 | 🐛 24 | 🌐 JavaScript | 📅 2026-05-06 - Linting rules for Cypress.
* Vitest
  * [ESLint Plugin Vitest](https://github.com/vitest-dev/eslint-plugin-vitest) ⭐ 480 | 🐛 15 | 🌐 TypeScript | 📅 2026-05-08 - ESLint plugin for Vitest.
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,897 | 🐛 755 | 🌐 TypeScript | 📅 2026-05-08 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,391 | 🐛 2,377 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
...
* [eslint-remote-tester](https://github.com/AriPerkkio/eslint-remote-tester) ⭐ 130 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-07 - CLI tool for testing given ESlint rules against multiple repositories at once.
...
* [eslint-multiplexer](https://github.com/pimlie/eslint-multiplexer) ⭐ 7 | 🐛 14 | 🌐 JavaScript | 📅 2026-05-07 - Multiplex eslint results and merge results for common files.
...
* [eslint-doc-generator](https://github.com/bmish/eslint-doc-generator) ⭐ 109 | 🐛 49 | 🌐 TypeScript | 📅 2026-04-23 - Generate documentation for your ESLint plugin including a rules table for your readme and header for your rule docs.
