...
* [Airbnb](https://github.com/airbnb/javascript/tree/master/packages/eslint-config-airbnb) ⭐ 148,118 | 🐛 159 | 🌐 JavaScript | 📅 2026-04-16 - Shareable config for [Airbnb's style guide](https://github.com/airbnb/javascript) ⭐ 148,118 | 🐛 159 | 🌐 JavaScript | 📅 2026-04-16.
* [ESLint](https://github.com/eslint/eslint/tree/master/packages/eslint-config-eslint) ⭐ 27,248 | 🐛 111 | 🌐 JavaScript | 📅 2026-05-13 - Contains the ESLint configuration used for projects maintained by the ESLint team.
...
* [Antfu Eslint Config](https://github.com/antfu/eslint-config) ⭐ 6,177 | 🐛 51 | 🌐 JavaScript | 📅 2026-05-11 - Anthony's ESLint config preset.
* [Standard](https://github.com/feross/eslint-config-standard) ⭐ 2,655 | 🐛 29 | 🌐 TypeScript | 📅 2026-05-12 - Shareable config for JavaScript [Standard Style](https://github.com/feross/standard) ⭐ 29,440 | 🐛 129 | 🌐 JavaScript | 📅 2025-07-11.
* [XO](https://github.com/xojs/eslint-config-xo) ⭐ 284 | 🐛 0 | 🌐 JavaScript | 📅 2026-04-04 - Shareable config for [XO](https://github.com/xojs/xo) ⭐ 7,972 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-02.

### Other Configs

* [Hardcore](https://github.com/EvgenyOrekhov/eslint-config-hardcore) ⭐ 468 | 🐛 48 | 🌐 JavaScript | 📅 2026-05-09 - The most strict (but practical) ESLint config out there.
...
* [XO](https://github.com/sindresorhus/xo) ⭐ 7,972 | 🐛 7 | 🌐 TypeScript | 📅 2026-04-02 - JavaScript happiness style linter ❤️.
...
* [Unicorn](https://github.com/sindresorhus/eslint-plugin-unicorn) ⭐ 5,014 | 🐛 373 | 🌐 JavaScript | 📅 2026-05-12 - Various awesome ESLint rules.
* [SonarJS](https://github.com/SonarSource/SonarJS/blob/master/packages/jsts/src/rules/README.md) ⭐ 1,233 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-12 - Rules detecting bugs and suspicious patterns.
...
* [Deslint](https://github.com/jaydrao215/deslint) ⭐ 2 | 🐛 8 | 🌐 TypeScript | 📅 2026-05-11 - The design quality gate for AI-generated frontend code. 20 rules covering arbitrary colors/spacing/typography, design-system drift, responsive coverage, and WCAG 2.2 / 2.1 AA accessibility across React, Vue, Svelte, Angular, and plain HTML.

### Compatibility

* [Compat](https://github.com/amilajack/eslint-plugin-compat) ⭐ 3,169 | 🐛 86 | 🌐 TypeScript | 📅 2026-04-29 - Lint browser compatibility of APIs used ([caniuse](http://caniuse.com/#search=fetch) as an ESLint plugin).
...
* [vanilla-extract](https://github.com/antebudimir/eslint-plugin-vanilla-extract) ⭐ 33 | 🐛 1 | 🌐 TypeScript | 📅 2026-04-29 - An ESLint plugin for enforcing CSS property ordering in [vanilla-extract CSS](https://github.com/vanilla-extract-css/vanilla-extract) ⭐ 10,371 | 🐛 81 | 🌐 TypeScript | 📅 2026-04-22 styles.
...
* [Markdown](https://github.com/eslint/eslint-plugin-markdown) ⭐ 565 | 🐛 13 | 🌐 JavaScript | 📅 2026-05-10 - Linting for JavaScript inside of Markdown.
...
* React
  * [React Hooks](https://github.com/facebook/react/tree/master/packages/eslint-plugin-react-hooks) ⭐ 244,992 | 🐛 1,294 | 🌐 JavaScript | 📅 2026-05-12 - Linting rules for React Hooks.
  * [React](https://github.com/yannickcr/eslint-plugin-react) ⭐ 9,281 | 🐛 352 | 🌐 JavaScript | 📅 2026-05-13 - Linting rules for React and JSX.
...
* [Meteor](https://github.com/meteor/meteor/tree/devel/npm-packages/eslint-plugin-meteor) ⭐ 44,781 | 🐛 372 | 🌐 JavaScript | 📅 2026-05-13 - Meteor specific linting rules for ESLint.
* Vue
  * [VueJS](https://github.com/vuejs/eslint-plugin-vue) ⭐ 4,596 | 🐛 206 | 🌐 TypeScript | 📅 2026-05-11 - Plugin for VueJS.
...
* [Angular](https://github.com/angular-eslint/angular-eslint) ⭐ 1,783 | 🐛 45 | 🌐 TypeScript | 📅 2026-05-12 - Linting rules for Angular (v2+).
* [AngularJS](https://github.com/Gillespie59/eslint-plugin-angular) ⭐ 621 | 🐛 73 | 🌐 JavaScript | 📅 2025-11-14 - Linting rules to adhere to the [John Papa's AngularJS Styleguide](https://github.com/johnpapa/angular-styleguide) ⭐ 23,663 | 🐛 1 | 🌐 Vim Snippet | 📅 2026-04-30.
* [Astro](https://github.com/ota-meshi/eslint-plugin-astro) ⭐ 426 | 🐛 33 | 🌐 TypeScript | 📅 2026-05-12 - Plugin for [Astro components](https://docs.astro.build/en/core-concepts/astro-components/).
...
* [Babel](https://github.com/babel/babel/tree/main/eslint/babel-eslint-plugin) ⭐ 43,899 | 🐛 752 | 🌐 TypeScript | 📅 2026-05-12 - Adds replacements for built-in rules to include Babel features.
* Flow
...
* [N](https://github.com/eslint-community/eslint-plugin-n) ⭐ 332 | 🐛 38 | 🌐 JavaScript | 📅 2026-05-06 - Additional ESLint's rules for Node.js. Properly maintained fork of no longer maintained `eslint-plugin-node`.
* [MDX](https://github.com/mdx-js/eslint-mdx/tree/master/packages/eslint-plugin-mdx) ⭐ 300 | 🐛 24 | 🌐 TypeScript | 📅 2026-05-12 - ESLint Parser/Plugin for MDX.
* [HTML](https://github.com/yeonjuan/html-eslint) ⭐ 261 | 🐛 32 | 🌐 JavaScript | 📅 2026-05-12 - ESLint plugin for HTML.
* JSON
...
* [Tailwind CSS](https://github.com/francoismassart/eslint-plugin-tailwindcss) ⭐ 2,062 | 🐛 138 | 🌐 JavaScript | 📅 2026-05-12 - Linting rules for Tailwind CSS classnames.
* GraphQL
...
* [JSDoc](https://github.com/gajus/eslint-plugin-jsdoc) ⭐ 1,215 | 🐛 34 | 🌐 JavaScript | 📅 2026-05-04 - Linting rules for JSDoc comments (including the JavaScript within `@example`).
* [Tailwind CSS v4](https://github.com/schoero/eslint-plugin-better-tailwindcss) ⭐ 774 | 🐛 21 | 🌐 TypeScript | 📅 2026-04-28 - ESLint plugin to help you write better tailwindcss by improving readability with formatting rules and enforcing best practices with linting rules.
* Lodash
...
* [jQuery](https://github.com/wikimedia/eslint-plugin-no-jquery) ⭐ 33 | 🐛 19 | 🌐 JavaScript | 📅 2026-05-06 - Linting rules for jQuery, including versioned configs for deprecated features.
...
* [import](https://github.com/benmosher/eslint-plugin-import) ⭐ 5,910 | 🐛 593 | 🌐 JavaScript | 📅 2026-04-27 - Linting of ES2015+ import/export syntax, and prevent issues with misspelling of file paths and import names.
* [functional](https://github.com/jonaskello/eslint-plugin-functional) ⭐ 974 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-12 - ESLint rules to disable mutation and promote fp in JavaScript and TypeScript.
...
* [boundaries](https://github.com/javierbrea/eslint-plugin-boundaries) ⭐ 883 | 🐛 18 | 🌐 TypeScript | 📅 2026-05-12 - Ensures that your architecture boundaries are respected by the elements in your project checking file structure and dependencies.
...
* [ReDoSDetector](https://github.com/tjenkinson/eslint-plugin-redos-detector) ⭐ 11 | 🐛 11 | 🌐 TypeScript | 📅 2026-05-12 - ESLint plugin for finding possible ReDoS vulnerabilities.
...
* [perfectionist sorting](https://github.com/azat-io/eslint-plugin-perfectionist) ⭐ 2,864 | 🐛 5 | 🌐 TypeScript | 📅 2026-05-10 - Sort objects, imports, TypeScript types, enums, JSX props, etc.
...
* [Testing Library](https://github.com/testing-library/eslint-plugin-testing-library) ⭐ 1,055 | 🐛 39 | 🌐 TypeScript | 📅 2026-05-12 - Linting rules for Testing Library.
* [Cypress](https://github.com/cypress-io/eslint-plugin-cypress) ⭐ 726 | 🐛 29 | 🌐 JavaScript | 📅 2026-05-12 - Linting rules for Cypress.
* Vitest
...
* [Playwright](https://github.com/playwright-community/eslint-plugin-playwright) ⭐ 382 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-07 - Linting rules for Playwright.
* Mocha
...
* [babel-eslint-parser](https://github.com/babel/babel/tree/main/eslint/babel-eslint-parser) ⭐ 43,899 | 🐛 752 | 🌐 TypeScript | 📅 2026-05-12 - Allows you to lint ALL valid Babel code with the fantastic ESLint.
...
* [confusing-browser-globals](https://github.com/facebook/create-react-app/tree/main/packages/confusing-browser-globals) ⭐ 103,389 | 🐛 2,384 | 🌐 JavaScript | 📅 2025-02-15 - A curated list of browser globals that commonly cause confusion and are not recommended to use without an explicit window. qualifier.
* [ES and browser globals](https://github.com/sindresorhus/globals) ⭐ 584 | 🐛 10 | 🌐 JavaScript | 📅 2026-05-01 (originally from ESLint)
...
* [eslint-interactive](https://github.com/mizdra/eslint-interactive) ⭐ 448 | 🐛 4 | 🌐 TypeScript | 📅 2026-05-12 - The CLI tool to fix huge number of ESLint errors.
